      ...
      <Card className="w-full max-w-md border-2 border-primary/20 shadow-xl">
        ...
        <CardContent className="flex flex-col items-center space-y-6 pt-4">
          ...
          <p className="text-center text-sm text-muted-foreground">
            We are redirecting you to the desktop app. If nothing happens, click
            the button below.
          </p>
          ...
          <Button
            asChild
            size="lg"
            className="w-full font-semibold shadow-lg transition-all hover:shadow-primary/20"
          >
            <a href={desktopDeepLink}>Proceed to Capture Desktop</a>
          </Button>

          <p className="text-[10px] text-muted-foreground italic">
            If nothing happens, ensure you have the Capture Desktop app
            installed.
          </p>
        </CardContent>
      </Card>
