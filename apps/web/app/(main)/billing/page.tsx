...
const plans = [
  {
    ...
    features: ["10 recordings / mo", "720p resolution", "Basic editing"],
    ...
    <div className="container mx-auto max-w-4xl space-y-10 p-6 lg:p-10">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        {plans.map((plan) => (
          <Card
            key={plan.name}
            className={`flex flex-col rounded-2xl border-accent/10 ${
              plan.highlight
                ? "bg-primary/5 shadow-sm ring-1 ring-primary"
      ...
      <Card className="mt-10 rounded-2xl border-accent/10 bg-accent/5">
