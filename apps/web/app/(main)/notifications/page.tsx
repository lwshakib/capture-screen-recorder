        ...
        {notifications.length === 0 ? (
          <Card className="rounded-3xl border-2 border-dashed border-accent/10 py-20">
            <CardContent className="flex flex-col items-center justify-center space-y-4">
              <div className="h-16 w-16 rounded-full bg-accent/5 flex items-center justify-center">
          ...
          notifications.map((notification) => (
            <Card 
              ...
              className={cn(
                ...
                notification.isRead ? "opacity-60 bg-transparent" : "bg-accent/5 shadow-sm border-primary/10"
              )}
            >
