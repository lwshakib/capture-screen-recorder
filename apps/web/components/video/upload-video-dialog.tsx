  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      if (newVideo) {
        ...
        const signedUrlResponse = await axios.get(`/api/s3/signed-url?key=${key}`);
      ...
      toast.error(error.response?.data?.error || "Failed to upload video. Please try again.");
    } finally {
      setUploading(false);
    }
  };
        ...
        <div className="flex flex-col space-y-4 py-4">
          {!file ? (
            <div 
              ...
              className="group relative flex flex-col items-center justify-center border-2 border-dashed border-muted-foreground/25 rounded-xl p-12 hover:border-primary/50 hover:bg-primary/5 transition-all cursor-pointer"
            >
              <div className="flex flex-col items-center gap-2 text-center">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">MP4, WebM, or QuickTime (max 100MB)</p>
                </div>
              </div>
              <Input
                ref={fileInputRef}
            ...
            <div className="relative flex items-center p-4 border rounded-xl bg-muted/30">
          ...
          {success && (
            <div className="flex items-center justify-center gap-2 text-sm font-medium text-green-500 animate-in fade-in zoom-in duration-300">
