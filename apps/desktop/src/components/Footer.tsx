...
export default function Footer() {
  ...
  return (
    ...
    <div className="draggable flex items-center justify-between p-4">
      <div className="non-draggable flex items-center gap-x-2">
        {/* Branding Logo */}
        <Logo />
      </div>
      <div className="non-draggable flex items-center gap-2">
        ...
        {user && !isUserLoading && (
          <div title="Logout">
            <LogOutIcon
              className="h-4 w-4 cursor-pointer text-gray-600 transition-colors hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200"
